...
/* Test funcs */
var AddMatrices = function(number){
    ...
    for(var i=0; i<number;i++) {
        ...
        sumOfTimeLoops = sumOfTimeLoops + (hrend[0] + hrend[1]/1e9);
    }

    return sumOfTimeLoops / number;
};

var CreateMatrices = function(number){
    var sumOfTimeLoops =0;
...
var MulMatrices = function(number){
    var sumOfTimeLoops =0;
...
var server = app.listen(3000, function () {
    ...
    var exeFile = require('child_process').execFile(
        "../exe/Release/WebAPISelfHostEigenProfilingServices.exe", function(err, data) {
            console.log(err)
